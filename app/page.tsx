    ...
    <section className="calculator" aria-label="Ministerial salary calculator">
      ...
      <div className="visual-strip">
        ...
        <div className="money-panel">
          ...
          <div className={'money-scene money-scene-'+graphic+(moneyUsesCoins?' money-scene-coins':'')} aria-hidden="true"><div className="money-field">{hdbFraction?<div className="hdb-fraction"><img className="hdb-silhouette" src="/art/hdb-block.png" alt=""/><img className="hdb-colour" src="/art/hdb-block.png" alt="" style={{clipPath:'inset(0 '+((1-equivalent.icons)*100)+'% 0 0)'}}/></div>:Array.from({length:moneyUsesCoins?50:48},(_,i)=>{
